    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        // Deklarera variabler för canvas och dess kontext
    ...
    alert(str);
        ...
        function pauseGame() {
            ...
            gamePaused = true;
            alert('Game Paused');
            // Implementera pauslogik om så önskas
        }
        ...
        function resetGame() {
            ...
            highscore = 0;
            updateHighscore();
            // Implementera resetlogik om så önskas
        }
...
document.addEventListener('keyup', function(event) {
    ...
    function gameOver() {
        ...
        let Game_Over = alert(`Game Over! Your score was ${score}. Highscore: ${highscore}`);
